...
2. Stage and commit all changes with `git commit -S`. Follow the project's commit conventions: short imperative subject line summarizing what changed, optional body explaining why. Include the `Co-Authored-By` trailer.
