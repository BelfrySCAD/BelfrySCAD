...
def _parse_args(argv):
    ...
    parser.add_argument("--view", metavar="OPTS",
                         help="Comma-separated: axes, crosshairs, edges, scales, "
                              "throwntogether, wireframe (.png only). throwntogether "
                              "paints face backsides magenta, as OpenSCAD's "
                              "--preview=throwntogether does")
